...
LE robotics (Pvt.) Ltd. is a local Research and Development facility that has been established by Prof. J.A.K.S. Jayasinghe who is a senior professor in the Department of Electronic and Telecommunication Engineering at the University of Moratuwa in Sri Lanka.\\
...
Following are a few of the features that the LE Robotics (Pvt.) Ltd. has to offer its customers.

\begin{itemize}
	\item Ease of robot customization to suit your process needs
	\item Various modes of operation depending on various motion and speed requirements
	\item Simple user interface with multi device support
	\item Convenient availability of spare parts
	\item Electronic control systems tailor-made to your organizational requirements
	\item Superior quality and reliability
\end{itemize}
