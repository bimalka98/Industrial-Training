...
This sections summarizes the \textit{internal} factors of the organization I observed during my industrial training, which are \textit{helpful} to achieve the business objectives of it.

	\begin{itemize}
		\item Great vision towards making the ``Made in Sri Lanka'' brand strong through products which are made to match international standards.
		\item Decades of experience in the industrial electronic product development industry in Sri Lanka.
		\item Unparalleled \ac{rnd} of advanced technologies.
	\end{itemize}


\subsection{Weaknesses}

This sections summarizes the \textit{internal} factors of the organization I observed during my industrial training, which are \textit{harmful} to achieve the business objectives of it.

	\begin{itemize}
		\item Heavily depends on the interns 
		\item Well-being or the career growth of the 
		employees was not of their concern
	\end{itemize}


\subsection{Opportunities}

This sections summarizes the \textit{external} factors of the organization I observed during my industrial training, which are \textit{helpful} to achieve the business objectives of it.

	\begin{itemize}
		\item Industrial automation is a fast growing 
		field
		\item Very few competitors in the market
	\end{itemize}


\subsection{Threats}

This sections summarizes the \textit{external} factors of the organization I observed during my industrial training, which are \textit{harmful} to achieve the business objectives of it.
...
\subsection{Strengths}
This sections summarizes the \textit{internal} factors of me I identified during my industrial training, which are \textit{helpful} to achieve my life goals of it.
	\begin{itemize}
		\item Can work under minimum supervision
		\item A team player with critical thinking abilities
		\item Fast learner who learns as needed
	\end{itemize} 


\subsection{Weaknesses}
This sections summarizes the \textit{internal} factors of me I identified during my industrial training, which are \textit{harmful} to achieve my life goals of it.
	\begin{itemize}
...
\subsection{Opportunities}
This sections summarizes the \textit{external} factors I identified during my industrial training, which are \textit{helpful} to achieve my life goals of it.
	\begin{itemize}
		\item Industrial automation is a fast growing field
		\item Professionals with both AI and Embedded 
...
This sections summarizes the \textit{external} factors I identified during my industrial training, which are \textit{helpful} to achieve my life goals of it.
	\begin{itemize}
		\item Below the average GPA in the department! (LOL)
	\end{itemize} 
