...
\begin{itemize}
	\item Google Search (\url{https://www.google.com/})
	\item Stack Overflow (\url{https://stackoverflow.com/})
	\item OpenCV Documentations (\url{https://docs.opencv.org/4.x/})
	\item EmguCV Documentations (\url{https://www.emgu.com/wiki/index.php/Documentation})
	\item GitHub Issues (\url{https://github.com/features/issues})
\end{itemize}
...
OpenCV (Open Source Computer Vision Library: \url{http://opencv.org}) is an open-source library that includes several hundreds of computer vision algorithms.
